...
import { workPeriod } from "../dataStructure/overview.ts";
...
const Overview: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-100 p-6 ">
      <div className="flex flex-col justify-center items-center flex-grow text-center bg-white rounded-lg shadow-lg border border-gray-300">
        <div className="flex justify-center items-end">
          <div className="pr-10 pb-0 text-center">
                  ...
                  {weeks.map((week, i) => (
                    <tr key={i}>
                      {week.map((day, j) => (
                        ...
                        >
                          {!isNaN(day) && (
                            <div className="z-10 pt-1">{day}</div>
                          )}
